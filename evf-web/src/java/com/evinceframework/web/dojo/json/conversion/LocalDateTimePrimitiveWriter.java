...
/**
 * Writes a {@link LocalDateTime} as a JSON object that can be interpreted on the web client in javascript.
 * 
 * <code>
 * 	{ 
 * 		"_customType": "Date",
 ...
 */
public class LocalDateTimePrimitiveWriter implements JsonPrimitiveWriter<LocalDateTime> {
